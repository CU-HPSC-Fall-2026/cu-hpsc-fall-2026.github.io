// From https://github.com/jakaspeh/concurrency/blob/master/ompForSchedule.cpp
// See also the blog: http://jakascorner.com/blog/2016/06/omp-for-scheduling.html
#include <iostream>
#include <string>
#include <vector>
#include <algorithm>
...
int main()
{
    ...
    schedule(scheduleStatic,   "schedule(static, 1):   ", n);
